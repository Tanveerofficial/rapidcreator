...
use App\Http\Requests\{StoreCsv_FileRequest, UpdateCsv_FileRequest};
...
class CsvFileController extends Controller
{
    ...
    public function store(StoreCsv_FileRequest $request)
    {
        ...
        $mainDirectory = "CSV_FILES";
        $subDirectory = Auth::user()->id;
        $csvDirectory = ucfirst($input['csv_name']);
        $this->createDirectory($mainDirectory);
        $this->createDirectory("$mainDirectory/$subDirectory");
        $this->createDirectory("$mainDirectory/$subDirectory/$csvDirectory");
        $saveFilePath = "$mainDirectory/$subDirectory/$csvDirectory/";
        if ($csvFile) {
            ...
            if ($request->file("csv_file")) {
                ...
                $this->saveCsvFile($existingCsvFilePath, $mergedCsvData);
    ...
    private function saveCsvFile($filePath, $data)
    {
