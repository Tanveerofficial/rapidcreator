...
<style>
    ...
    .images_checkbox input[type="checkbox"][id^="myCheckbox"] {
        display: none;
    }

    .images_checkbox label {
    ...
    .images_checkbox input[type="checkbox"]:checked + label {
        border-color: #ddd;
    }

    .images_checkbox input[type="checkbox"]:checked + label:before {
        content: "✓";
        background-color: grey;
        transform: scale(1);
    }

    .images_checkbox input[type="checkbox"]:checked + label img {
        transform: scale(0.9);
        z-index: -1;
    }
</style>
