<div id="kt_app_header" class="app-header " data-kt-sticky="true" data-kt-sticky-activate="{default: true, lg: true}" data-kt-sticky-name="app-header-minimize" data-kt-sticky-offset="{default: '200px', lg: '0'}" data-kt-sticky-animation="false" style="top: 0px;" data-kt-sticky-enabled="true">
    ...
    -moz-box-shadow: 2px 10px 5px -1px rgba(240,233,233,1);">
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="http://localhost:8000/../index.html" class="d-lg-none">
                <img alt="Logo" src="http://localhost:8000/../assets/media/logos/default-small.svg" class="h-30px">
            </a>
        </div>
        <!--end::Mobile logo-->
            ...
            <div class="app-navbar flex-shrink-0">
                ...
                <div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
                    ...
                    <div class="cursor-pointer symbol symbol-35px" data-kt-menu-trigger="{default: 'click', lg: 'hover'}" data-kt-menu-attach="parent" data-kt-menu-placement="bottom-end">
                        <img src="http://localhost:8000/../assets/media/avatars/300-3.jpg" class="rounded-3" alt="user">
                    </div>
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                <div class="symbol symbol-50px me-5">
                                    <img alt="Logo" src="http://localhost:8000/../assets/media/avatars/300-3.jpg">
                                </div>
