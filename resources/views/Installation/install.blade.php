            ...
            <div class="d-flex flex-center flex-column flex-lg-row-fluid">
                <div class="w-lg-500px p-10">
                    <form id="installationForm" class="needs-validation" novalidate>
                        ...
                        <div class="mb-3">
                            <label for="password" class="form-label">{{ __('Database-Password') }}</label>
                            <div class="position-relative auth-pass-inputgroup mb-3">
                                <input id="password-input" type="password"
                                       class="form-control pe-5 password-input"
                                       name="database_password" required autocomplete="current-password" placeholder="Enter Your Database Password">
                                <div class="invalid-feedback">
