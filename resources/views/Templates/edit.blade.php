        ...
        <div class="d-flex flex-column flex-column-fluid">
            <div id="kt_app_toolbar" class="app-toolbar  py-3 py-lg-6 ">
                <div id="kt_app_toolbar_container" class="app-container  container-xxl d-flex flex-stack ">
                    ...
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3 ">
                        <a href="{{url('/template')}}" class="btn btn-primary btn-sm">
                            + Manage Template
                        </a>
                    </div>
                </div>
                        ...
                        <div class="col-lg-6 col-xl-6 col-md-6" style="display: block" id="image_processing">
                            <div class="card custom-card mx-auto" style="width: 502px; height: 519px;">
                                ...
                                <div id="loader_preview" style="display: none">
                                    <div class="card-body" style="height: 100%; padding-top: 50%; position: absolute; padding-left: 40%;">
                                    ...
                                    <form id="form_submit" data-parsley-validate="">
                                        <div class="row mt-5">
                                            <div class="fv-row mb-7">
                                                ...
                                                <input type="text" class="form-control" id="csv_text" value="{{$template->title}}"
                                            ...
                                            <div class="fv-row mb-7" id="csv_field" style="display: block">
                                                <label class="fs-6 mb-2" style="font-weight: bold;">Choose CSV File</label>
                                                <br>
                                                <select class="form-control" id="gettingCSV">
                                                    <option value="" selected disabled>--Choose CSV File--</option>
                                                    @foreach ($csv_files as $csv_file)
                                                        @php $explode_name = explode('.csv', $csv_file->csv_file); @endphp
                                                        <option value="{{ $csv_file->csv_file }}" {{$template->csv_file==$csv_file->csv_file?"selected":""}}>{{ $explode_name[0] }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="fv-row mb-7" style="display: none" id="csv_names">
                                                <label class="fs-6 mb-2" style="font-weight: bold;">Choose CSV Data</label>
                                                <br>
                                                <select class="form-control" id="getting_names">
                                                    <option value="" selected disabled>--Choose CSV Data--</option>
                                                </select>
                                            </div>
                                            <div class="fv-row mb-7">
                                                <label for="fs-6 mb-2" style="font-weight: bold;">Fonts Type <strong class="text-danger">*</strong></label>
                                                <br><br>
                                                <select id="selectFontType" class="form-control">
                                                    <option value="" selected disabled>--Choose Font Type--</option>
                                                    <option value="own" {{$template->font_type=="own"?"selected":""}}>Own Fonts</option>
                                                    <option value="google" {{$template->font_type=="google"?"selected":""}}>Google Fonts</option>
                                                </select>
                                            </div>
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="mb-7">
                                                        <label for="fs-6 mb-2" style="font-weight: bold;">Choose Font Family <strong class="text-danger">*</strong></label>
                                                        <br><br>
                                                        <select class="form-control" id="applyFont">
                                                            <option value="" selected disabled>--Choose Font Family--</option>
                                                            @foreach($getFontFamilies as $fontFamily)
                                                                <option value="{{$fontFamily}}" {{$fontFamily==$template->font_family?"selected":""}}>{{$fontFamily}}</option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                <div class="col-6">
                                                    <div class="mb-7">
                                                        <label for="fs-6 mb-2" style="font-weight: bold;">Add Variants to Fonts <strong class="text-danger">*</strong></label>
                                                        <br><br>
                                                        <select id="selectFontVariants" class="form-control">
                                                            <option value="" selected disabled>--Choose Font Variant--</option>
                                                            @foreach($variants as $key=>$value)
                                                                <option value="{{$key}}" {{$value.".ttf"==$template->variants?"selected":""}}>{{$value}}</option>
                                                            @endforeach
                                                        </select>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <div class="mb-7">
                                                        <label for="fs-6 mb-2" style="font-weight: bold;">Text Alignment</label>
                                                        <br><br>
                                                        <div class="btn-group mr-2" role="group" aria-label="..." style="background-color:#2d3250; width: 100%;">
                                                            <button type="button" id="applyAlignment" value="baseline" style="background-color:#2d3250" title="Align Left" class="btn btn-outline-secondary btn-icon"><i class="text-white fas fa-align-left"></i></button>
                                                            <button type="button" id="applyAlignment" value="center" style="background-color:#2d3250" title="Align Center" class="btn btn-outline-secondary btn-icon"><i class="text-white fas fa-align-center"></i></button>
                                                            <button type="button" id="applyAlignment" value="end" style="background-color:#2d3250" title="Align Right" class="btn btn-outline-secondary btn-icon"><i class="text-white fas fa-align-right"></i></button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="fv-row mb-7">
                                                <label for="fs-6 mb-2" style="font-weight: bold;">Choose Text Color</label>
                                                <br>
                                                <img style="min-width:16px; min-height:16px; box-sizing:unset; box-shadow:none; background:unset; padding:0 6px 0 0; cursor:pointer;" src="{{asset('images/icon16.png')}}" title="Choose with ColorPick Eyedropper" class="colorpick-eyedropper-input-trigger">
                                                <input class="form-control" type="color" value="{{$template->color}}" id="example-color-input" colorpick-eyedropper-active="true" style="height: 45px;">
                                            </div>
                                        </div>
                                    </form>
                                </div>
                            ...
                            <div class="card custom-card bg-dark" style="width: 502px;">
                                <div class="card-body pt-9 pb-0" style="background-color: #2d3250; width: 500px;">
                                    <div id="capture_preview" class="bg-dark">
                                        <div id="container" class="ui-widget-content" style="width: {{$template->container_width}}px; height: {{$template->container_height}}px; left: {{$template->container_position_left}}px; top: {{$template->container_position_top}}px;">
                                            <div id="input" style="width: {{$template->input_width}}px; height: {{$template->input_height}}px; left: {{$template->input_position_left}}px; top: {{$template->input_position_top}}px; font-size: {{$template->input_font_size}}px; color: {{$template->color}};">{{$template->title}}</div>
                                        </div>
                                        <img src="{{ asset($template->template_picture) }}" alt="Image not found" style="background-color: black;" class="img-fluid" id="image">
                                    </div>
                                    <br><br>
                                </div>
                                <div class="card-footer p-3 text-center" id="preview_image" style="display: block; background-color: #2d3250; border-bottom-right-radius: 8px; border-bottom-left-radius: 8px;">
                                    <button type="submit" class="btn" id="preview" style="background-color:white;">
                                        <span class="indicator-label">Re-Generate Template</span>
                                        <i class="fas fa-arrow-right text-dark"></i>
                                    </button>
                                </div>
                                <div class="card-footer p-3 text-center" id="edit_image" style="display: none; background-color: #2d3250; border-bottom-right-radius: 8px; border-bottom-left-radius: 8px;">
                                    <a href="{{ url('template') }}" type="button" class="btn" id="details" style="background-color:white;">
                                        <span class="indicator-label">View Templates</span>
...
@section('script')
    ...
    <script>
        $(document).ready(function (){
            ...
            var selectedFont='{{$template->font_family}}';
            var fontUrl='{{url($template->ttf_file)}}';
    ...
    <script>
        ...
        function sendAjaxRequest(dataArray) {
            const csv_file = $("#gettingCSV").val();
            const fontType = $("#selectFontType").val();
            const textColor = $("#example-color-input").val();
            const fontFamily = $("#applyFont").val();
            const textEffect = $("#selectFontVariants").val();
            const image_path = $("#image").attr("src");
            const get_id = $("#get_id").val();
            const alignment = $("#applyAlignment").val() || "center";
            const container = $("#container");
            const containerPosition = container.position();
            const containerPositionLeft = containerPosition ? containerPosition.left : 0;
            const containerPositionTop = containerPosition ? containerPosition.top : 0;
            const containerWidth = container.width();
            const containerHeight = container.height();
            const csv_file_name = csv_file ? `${csv_file}.csv` : "";
            $.ajaxSetup({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                }
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.message === 200) {
                        ...
                        Swal.fire({
                            toast: true,
                            icon: 'error',
                            title: 'Template not created! Please try again later',
                            animation: false,
                            position: 'top-right',
                            showConfirmButton: false,
                            timer: 3000,
                ...
                error: function(error) {
                    ...
                    $("#fontVariant").text(errors.textEffect || "Error in text effect");
                    $("#fontFamily").text(errors.font_family || "Error in font family");
                }
            });
        }
        function editImage() {
            ...
            $fileInput.change(function (event) {
                ...
                if (file) {
                    ...
                    reader.onload = function (e) {
                        const img = new Image();
                        img.onload = function () {
                            if (img.width < 4500 || img.height < 3939) {
                                Swal.fire({
                                    toast: true,
                                    icon: 'error',
                                    title: 'Maximum dimension is 4500x3939!',
                                    animation: false,
                                    position: 'top-right',
                                    showConfirmButton: false,
                                    timer: 3000,
